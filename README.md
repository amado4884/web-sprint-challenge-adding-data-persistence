...
1. Explain the difference between `Relational Databases` and `SQL`.
   Relational Databases (RDBMS) is the actual peice of software being used to store the data. Like SQLite, Postgres, etc.
   SQL is the language used to communicate or query with some of these Relational Databases

2. Why do tables need a `primary key`?
   To properly identify each record. They're always unique.

3. What is the name given to a table column that references the primary key on another table.
   Foreign Key

4. What do we need in order to have a _many to many_ relationship between two tables.
   An intermediary table that references the relationships.
